...
Актуальную версию JUnit всегда можно узнать в [Maven Repository](https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-api). После подключения проект будет собираться вместе с JUnit.
