...
GGR (Grid Router) — это прокси-сервер(балансировщик), который позволяет управлять сессиями в Selenoid. Он позволяет управлять сессиями, перенаправлять запросы на Selenoid и многое другое.
